	...
	<div class="row">
		...
		<div class="col-md-8 col-sm-8">
			...
			<div class="box box-know hide">
				<div class="box-body form-inline">
					<h3>Bolehkah saya tahu apakah Anda mengetahui <?php echo $event_name ?> yang merupakan bagian dari ConnecTechAsia, yang diselenggarakan pada tanggal 26-28 Juni di Suntec Singapore ?</h3>
					<p class="info">May I know if you are aware of <?php echo $event_name ?>, a part of ConnecTechAsia, which is happening from 26 – 28 June at Suntec Singapore?</p>
					<label>Jawaban :</label>
			...
			<div class="box box-know-no hide">
				<div class="box-body form-inline">
					<?php if ($this->event['id'] == 1): ?>
						...
						<?php else: ?>
						<p class="info">(Berikan info tentang CommunicAsia2018, NXTAsia2018 dan ConnecTechAsia)</p>
					<?php endif; ?>
					<button type="button" class="btn btn-default btn-xs doc">Klik disini untuk melihat Info</button>
				</div>
			</div>
			...
			<div class="box box-pre-registered-no hide">
				<div class="box-body form-inline">
					<h3>Dapatkah saya mengirimkan undangan via email kepada Anda untuk menghadiri <?php echo $event_name ?> bersamaan dengan informasi acara dan link pendaftaran secara online ? </h3>
					<p class="info">Can I email to you the invitation to attend <?php echo $event_name ?> along with the event information and a link to pre-register online? </p>
					<label>Jawaban :</label>
