...
-- Dumping structure for table bca2018p2.call_history
...
-- Dumping data for table bca2018p2.call_history: ~0 rows (approximately)
/*!40000 ALTER TABLE `call_history` DISABLE KEYS */;
/*!40000 ALTER TABLE `call_history` ENABLE KEYS */;


-- Dumping structure for table bca2018p2.candidate
CREATE TABLE IF NOT EXISTS `candidate` (
  ...
  `vip_code` varchar(100) NOT NULL DEFAULT '0',
  `know` tinyint(4) NOT NULL DEFAULT '0',
  `pre_registered` tinyint(4) NOT NULL DEFAULT '0',
  `send_email` tinyint(4) NOT NULL DEFAULT '0',
  `email_sent` varchar(100) NOT NULL DEFAULT '0',
  `remark` text,
...
-- Dumping data for table bca2018p2.candidate: ~0 rows (approximately)
/*!40000 ALTER TABLE `candidate` DISABLE KEYS */;
/*!40000 ALTER TABLE `candidate` ENABLE KEYS */;


-- Dumping structure for table bca2018p2.candidate_status
...
-- Dumping data for table bca2018p2.candidate_status: ~17 rows (approximately)
...
INSERT INTO `candidate_status` (`id`, `name`, `parent`, `user_create`, `date_create`, `user_update`, `date_update`) VALUES
	...
	(109, 'Callback', 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00'),
	(110, 'Answering Machine', 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00'),
	(111, 'Voice Mail/Left Msg', 1, 0, '2018-03-13 20:23:27', 0, '2018-03-13 20:23:29'),
	(112, 'Wrong Number', 1, 0, '2018-03-13 20:23:56', 0, '2018-03-13 20:23:58'),
	(113, 'No Longer in Business', 1, 0, '2018-03-13 20:24:16', 0, '2018-03-13 20:24:18'),
	(114, 'Others', 1, 0, '2018-03-13 20:24:36', 0, '2018-03-13 20:24:38');
/*!40000 ALTER TABLE `candidate_status` ENABLE KEYS */;


-- Dumping structure for table bca2018p2.event
...
-- Dumping data for table bca2018p2.event: ~4 rows (approximately)
...
INSERT INTO `event` (`id`, `name`, `place`, `date`, `web`, `pre_register`, `user_create`, `date_create`, `user_update`, `date_update`) VALUES
	...
	(3, 'Broadcast Asia 2018 VIP', '', '', '', '', 0, '2018-03-13 07:45:15', 0, '2018-03-13 07:45:15'),
	(4, 'Communic Asia 2018 VIP', '', '', '', '', 0, '2018-03-13 07:45:35', 0, '2018-03-13 07:45:35');
/*!40000 ALTER TABLE `event` ENABLE KEYS */;


-- Dumping structure for table bca2018p2.user
...
-- Dumping data for table bca2018p2.user: ~4 rows (approximately)
...
INSERT INTO `user` (`id`, `name`, `username`, `password`, `level`, `ip_login`, `date_login`, `user_agent`, `status`, `user_create`, `date_create`, `user_update`, `date_update`) VALUES
	(1, 'Adam Prasetia', 'damz', '202cb962ac59075b964b07152d234b70', 1, '::1', '2018-03-15 08:13:41', 'Windows 7(Google Chrome 64.0.3282.186)', 1, 0, '0000-00-00 00:00:00', 12, '2016-02-01 23:44:22'),
...
-- Dumping structure for table bca2018p2.user_level
...
-- Dumping data for table bca2018p2.user_status: ~2 rows (approximately)
